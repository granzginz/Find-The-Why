...
public class InformasiPengembang extends LayoutGameBaseScene {
	...
	public void createScene() {
		...
		bkg = new Sprite(GameCamera.getInstance().getCAMERA_WIDTH() / 2,
				...
				resourcesManagerAsset.latarInpeng_region, layoutgame_vbom) {
	...
	public LayoutSceneType getSceneType() {
		...
		return LayoutSceneType.SCENE_INFORMASI_PENGEMBANG;
	}
